...
import com.supertrampai.springbootsimpleswagger.action.BookController;
...
public class SpringBootSimpleSwaggerApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringBootSimpleSwaggerApplication.class, args);
    }
    ...
    public Docket petApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.supertrampai"))// RequestHandlerSelectors.any()
